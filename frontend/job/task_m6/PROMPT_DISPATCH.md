...
唯一修改：ReportTimeline + ReportRiskPanel + ReportSections
```
...
唯一修改：`views/analysis/reports.vue`
```
...
唯一修改：AlertBoard + AlertTable + AlertDetailDrawer
```
...
唯一修改：`views/analysis/alerts.vue`
```
...
唯一修改：TopBar + AlertDigest + LatestReportCard
